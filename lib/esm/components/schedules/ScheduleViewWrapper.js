...
const ScheduleViewWrapper = ({ scheduleByEventPlace, weekStartsOn, isInDarkMode, withList, eventTypeData, locale, modalContent, withDays, colorCellByEvents, eventsTextColor, eventsName, eventsNameUs, }) => {
    ...
    return (_jsxs("div", { className: "pr-0 pl-2 w-full", style: { padding: "1em 4em 4em 4em" }, children: [_jsxs("div", { children: [isInCalendarType === "calendar" || withDays ? (_jsxs("h1", { style: {
                            fontSize: 18,
                            fontWeight: "bold",
                            padding: 0,
                            marginTop: "2vh",
