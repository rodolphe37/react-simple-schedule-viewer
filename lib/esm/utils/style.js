...
export const ParametersContainerStyle = (width) => width < breakpoints.xs
    ? { paddingTop: "9rem" }
    : width < breakpoints.sm
        ...
        : width > breakpoints.md
            ? { paddingTop: "2rem" }
            : { paddingTop: "6rem" };
export const schedulesContainerStyle = (width) => width < breakpoints.xs
...
export const bgGradientGray100To50And900To800 = "bg-gradient-to-b from-gray-100 to-gray-50 dark:from-gray-900 dark:to-gray-800";
export const bgGray100Gradient900To800 = "bg-gray-100 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800";
