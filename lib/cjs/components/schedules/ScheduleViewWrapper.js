...
const ScheduleViewWrapper = ({ scheduleByEventPlace, weekStartsOn, isInDarkMode, withList, eventTypeData, locale, modalContent, withDays, colorCellByEvents, eventsTextColor, eventsName, eventsNameUs, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "pr-0 pl-2 w-full", style: { padding: "1em 4em 4em 4em" }, children: [(0, jsx_runtime_1.jsxs)("div", { children: [isInCalendarType === "calendar" || withDays ? ((0, jsx_runtime_1.jsxs)("h1", { style: {
                            fontSize: 18,
                            fontWeight: "bold",
                            padding: 0,
                            marginTop: "2vh",
