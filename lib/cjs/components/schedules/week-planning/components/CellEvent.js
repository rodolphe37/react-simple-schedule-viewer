...
const CellEvent = ({ timeEvent: event, events, timeEventId, startTime, day, eventIdToDisplay, isInDarkMode, eventTypeData, locale, modalContent, scheduleIdentifier, eventArray, colorCellByEvents, eventsTextColor, eventsName, eventsNameUs, }) => {
    const { eventInstructionNameFr, eventInstructionNameUs } = (0, useEventNamesController_1.default)({ eventsName, eventsNameUs });
    const setEventIdToDisplay = (0, jotai_1.useSetAtom)(eventIdToDisplayAtom_1.default);
